...
description: "Process a preserved StarNet star layer: neutralize false SHO star colors, substantially dim bright stars while retaining faint stars, review candidates, and publish for star recombination."
---

# siril-star-processing

Orchestration version: **1.0.1**  
Processing engine version: **1.0.0**
...
The v1.0.0 processing engine generates three target-adaptive candidates using Siril 1.4.4 only for image transforms.
...
3. is checked for clipping and preservation metrics;
4. is returned as an exact preview path for visual review.
...
Notes must be specific enough to show that color neutrality, bright-star dominance, dim-star retention, profiles/artifacts, and overall balance were actually assessed.
