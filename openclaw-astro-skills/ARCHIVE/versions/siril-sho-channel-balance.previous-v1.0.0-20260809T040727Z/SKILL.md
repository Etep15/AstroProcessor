...
description: "Autonomously balance the pure linear SHO composition with bounded Siril PixelMath refinement, mandatory image review, and preservation-safe publication."
user-invocable: true
metadata: {"openclaw":{"os":["linux"]}}
---

# Siril SHO Channel Balance 1.0.0
...
Current v1.0.0 compatibility temporarily accepts the validated
