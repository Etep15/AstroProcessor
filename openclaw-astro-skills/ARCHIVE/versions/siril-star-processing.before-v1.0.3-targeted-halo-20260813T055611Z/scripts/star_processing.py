...
def advance(project_name: str) -> dict:
    ...
    return {
        ...
        "run_root": str(run_root),
        "selection_rule": "Select the candidate with the best overall balance of neutral star color, minimal yellow/orange/magenta halos, reduced star dominance, retention of dim stars, preserved profiles and no clipping.",
        "read_target_policy": {
