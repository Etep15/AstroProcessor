...
expected_new_sha="412f600decefb7b357df2ace9ab8970f8a2667339f682a57c8e189a97e41f227"
expected_black_point_sha="86f274e7315869a5b67442f6cdec0e9f4d78e2003d40fd533510ad2c4aaeca18"
timestamp="$(date +%Y%m%d-%H%M%S)"
staging="$workspace/skills/.siril-green-reduction-v1.0.2-$timestamp"
backup_root="/home/peter/.openclaw/backups/codewarrior-skills/siril-green-reduction"
backup_dir="$backup_root/before-v1.0.2-$timestamp"
...
printf '\n===== Install Siril green-reduction 1.0.2 =====\n'
...
if [ "$staged_version" != "1.0.2" ] || [ "$staged_sha" != "$expected_new_sha" ]; then printf 'ERROR: staged helper validation failed.\n'; exit 1; fi
...
printf '\n===== Publish tested green-reduction v1.0.2 skill =====\n'
...
if [ "$installed_version" != "1.0.2" ] || [ "$installed_sha" != "$expected_new_sha" ]; then printf 'ERROR: final installed helper verification failed.\n'; exit 1; fi
printf '\nSIRIL GREEN REDUCTION 1.0.2 INSTALLATION COMPLETE\n'
