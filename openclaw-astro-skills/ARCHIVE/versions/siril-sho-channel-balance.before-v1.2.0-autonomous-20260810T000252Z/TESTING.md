...
6. the existing M16 legacy direct-GHS StarNet manifest is rejected by the native-only channel-balance source contract without generating a candidate;
...
Native source-contract revision: `native-starnet-channel-balance-v1`. Legacy direct-StarNet-to-GHS manifests are intentionally rejected after this cleanup.
