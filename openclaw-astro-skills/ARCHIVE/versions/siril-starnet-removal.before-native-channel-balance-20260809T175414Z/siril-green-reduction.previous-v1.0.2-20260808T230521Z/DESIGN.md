# siril-green-reduction v1.0.2 design
...
v1.0.2 correction: arithmetic RGB-mean median change is also diagnostic only and
...
## v1.0.2 review-contract hardening

v1.0.2 does not change Siril processing, candidate amounts, quality gates, or
