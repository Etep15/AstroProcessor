# Install siril-green-reduction v1.0.2
...
```bash
scp ~/Downloads/siril-green-reduction-v1.0.2.zip \
...
```bash
bash <<'BASH'
package="/home/peter/siril-green-reduction-v1.0.2.zip"
expected_sha256="<PACKAGE_SHA256_FROM_CHAT>"
timestamp="$(date +%Y%m%d-%H%M%S)"
extract_root="/home/peter/siril-green-reduction-v1.0.2-$timestamp"
...
if [ ! -f "$package" ]; then
    ...
    if [ "$actual" != "$expected_sha256" ]; then
        ...
        skill="$extract_root/siril-green-reduction-v1.0.2"
