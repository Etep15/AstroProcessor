...
For every eligible candidate, the candidate-specific note must state what was
actually seen regarding:
- residual/unwanted green;
- magenta or purple over-correction;
- preservation of faint outer emission, Pillars, and dark-lane structure.

Do not justify a candidate only because it matches the baseline or numerical
recommendation.
