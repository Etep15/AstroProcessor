...
description: "Run StarNet removal through the canonical v1.5.4 context-safe orchestrator, visually compare compact candidate panels, and publish native starless/starmask/unscreen products."
user-invocable: true
...
Installed orchestration version: **1.5.4**.
...
Successful v1.5.4 publication also writes:

```text
processing/starnet/orchestration-review-v1.5.4.json
```
...
├── orchestration-review-v1.5.4.json
